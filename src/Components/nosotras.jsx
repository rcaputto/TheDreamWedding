...
function Nosotras () {
    return (
        ...
        <h1 className='nosotrasCopy'>Somos May y Miri, dos argentinas Todo Terreno pisando fuerte en España, que creamos este proyecto conjunto de WEDDING PLANNER Y ORGANIZACION DE EVENTOS para plasmar nuestra esencia en uno de los momentos más lindos de su vida… Tu boda soñada!
